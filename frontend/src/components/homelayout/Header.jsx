...
const NOTIFICATIONS = [
  {
    ...
    user: "Kate Young",
    avatar:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbk-kYD_0sBDaSkcki5qP9gmQun3vq5Gan4A&s",
          ...
          {user && (
            <div className="flex space-x-2">
              <button
                ...
                className="flex-1 flex items-center justify-center space-x-2 py-2 px-4 rounded-lg bg-white/10 text-white hover:bg-white/20 transition-colors"
              >
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center space-x-2 py-2 px-4 rounded-lg bg-red-500/10 text-red-500 hover:bg-red-500/20 transition-colors"
              >
                    ...
                    >
                      {user.avatar ? (
                        <img
                          src={user.avatar}
                          alt={user.name}
                          className="w-8 h-8 rounded-full border-2 border-green-400 flex-shrink-0"
                        />
                      ) : (
