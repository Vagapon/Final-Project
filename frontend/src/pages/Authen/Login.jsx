...
export default function Login() {
  ...
  const [isFirebaseReady, setIsFirebaseReady] = useState(true); // Set to true by default
  ...
  // Firebase is ready by default, no need to preload
            ...
            <div className="mb-6">
              ...
              >
                ...
                <span className="text-sm font-medium">
                  {isGoogleLoading ? "Đang đăng nhập..." : "Sign in with Google"}
                </span>
              </button>
            </div>
