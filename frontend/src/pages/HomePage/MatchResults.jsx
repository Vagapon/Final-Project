...
function MatchResults() {
  ...
  const getResultIcon = (result) => {
    switch (result) {
      ...
      case "loss":
        return <TrendingUp className="w-5 h-5 rotate-180 text-white" />;
      case "draw":
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-6">
          {loading ? (
            ...
            >
              {/* Result Status Badge */}
              <div
                className={`h-1 bg-gradient-to-r ${getResultColor(match.result)}`}
              ></div>
              ...
              <div className="p-6 flex flex-col justify-between h-[420px]">
                ...
                {/* Match Title */}
                <h4 className="text-lg font-bold text-center text-gray-800 mb-2 group-hover:text-gray-900 transition-colors">
                  {match.title}
                </h4>
          ...
          >
            ...
            <div className="px-6 py-8">
              ...
              <div className="bg-gray-50 rounded-lg p-6 mb-6">
                <h5 className="text-center text-gray-700 font-medium mb-6">
                  Thống kê trận đấu
                </h5>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-lg font-semibold text-gray-900">
                        {selectedMatch.homeTeam.stats.possession}%
                      </span>
                      <span className="text-sm text-gray-500">
                        Kiểm soát bóng
                      </span>
                      <span className="text-lg font-semibold text-gray-900">
                        {selectedMatch.awayTeam.stats.possession}%
                      </span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="flex-1 bg-gray-200 rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${selectedMatch.homeTeam.stats.possession}%`,
                          }}
                        ></div>
                      </div>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-lg font-semibold text-gray-900">
                        {selectedMatch.homeTeam.stats.shots}
                      </span>
                      <span className="text-sm text-gray-500">Cú sút</span>
                      <span className="text-lg font-semibold text-gray-900">
                        {selectedMatch.awayTeam.stats.shots}
                      </span>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-lg font-semibold text-gray-900">
                        {selectedMatch.homeTeam.stats.corners}
                      </span>
                      <span className="text-sm text-gray-500">Phạt góc</span>
                      <span className="text-lg font-semibold text-gray-900">
                        {selectedMatch.awayTeam.stats.corners}
                      </span>
                    </div>
                  </div>
                </div>
